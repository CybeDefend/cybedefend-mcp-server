// src/tools/listVulnerabilitiesCicd.ts
import axios from "axios";
import { forwardAuth } from "../utils/forwardAuth.js";
import { API_BASE } from "../utils/apiBase.js";
import { resolveProjectId } from "../utils/projectId.js";

export const listVulnerabilitiesCicdTool = {
    name: "list_vulnerabilities_cicd",
    description:
        "List CI/CD vulnerabilities of a project with optional filters and pagination. If projectId is omitted, uses CYBEDEFEND_PROJECT_ID.",
    inputSchema: {
        type: "object",
        properties: {
    ...
    async run(params: any, clientHeaders: Record<string, string | undefined>) {
        ...
        const res = await axios.get(`${API_BASE}/project/${pid}/results/cicd`, {
